...
```text
HGT_rech ≈ Vollbenutzungsstunden × (Raumtemperatur − NAT)
...
Der Vergleich bleibt bewusst vereinfacht. Er nutzt die gemeinsamen INCA-Klimakennwerte, setzt die Verluste aber auf die gewählte Raumtemperatur um und berücksichtigt interne sowie solare Gewinne mit einem pauschalen Nutzungsfaktor. Dadurch bleibt der U-Wert-HWB unabhängig vom Verbrauchs-HWB, ist aber robuster als der frühere Ansatz mit 15 °C Bilanztemperatur und vollständigem Gewinnabzug.
