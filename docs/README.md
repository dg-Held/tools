...
**Stand:** 17.08.2026  
**Gültiger Projektstand:** Standortpass Gebäude & Umgebung V1.0, Klima am Standort V1.0, Heizlast abschätzen V1.0, Energiefluss im Gebäude V4.4, Bauteil & Sanierung V1.0, Wirtschaftlichkeit V1.0 sowie Sanierungsfahrplan V0.3.2 als Abnahmekandidat im Direktlink-Pilot. Die V1.0-Basis bleibt eingefroren; der Sanierungsfahrplan baut als neue Orchestrierungs- und Beratungsschicht darauf auf.
